<template>
    <div class="star-rating">
        ...
        <div class="star-rating__colored" :style="ratingWidhtStyle" >
...
<style lang="scss" scoped>
    ...
    flex-shrink: 0;
    &--colored{
      background: url('../../public/img/Star22.svg') center no-repeat;

    // background: #ff662d;
    }
     &--outlined{
      background: url('../../public/img/Star11.svg') center no-repeat;
